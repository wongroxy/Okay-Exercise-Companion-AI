import React, { useRef, useEffect, useState, MouseEvent as ReactMouseEvent, useCallback, useLayoutEffect, TouchEvent as ReactTouchEvent } from 'react';
...
export const ImageEditor: React.FC<ImageEditorProps> = ({ file, onSave, onCancel }) => {
  ...
  useEffect(() => {
    ...
    return () => {
      isActive = false;
      // Delay revocation to allow image to load in Strict Mode
      setTimeout(() => {
