          ...
          <div key={url} className="relative group aspect-square">
            ...
            <div className="absolute inset-0 bg-black/0 group-hover:bg-black/60 transition-all flex items-center justify-center">
              <button
                ...
                className="absolute bottom-2 left-2 bg-black/50 text-white rounded-full p-1.5 hover:bg-black/75 transition-colors focus:outline-none focus:ring-2 focus:ring-white opacity-0 group-hover:opacity-100"
              ...
              <button
                ...
                className="absolute top-2 right-2 bg-black/50 text-white rounded-full p-1.5 hover:bg-black/75 transition-colors focus:outline-none focus:ring-2 focus:ring-white opacity-0 group-hover:opacity-100"
